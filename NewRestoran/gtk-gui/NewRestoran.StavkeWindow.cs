...
namespace NewRestoran
{
	public partial class StavkeWindow
	{
		...
		protected virtual void Build()
		{
			...
			this.entrySearch.WidthRequest = 134;
			...
			global::Gtk.Box.BoxChild w6 = ((global::Gtk.Box.BoxChild)(this.vboxNodeView[this.hbox3]));
			w6.Position = 0;
			w6.Expand = false;
			w6.Fill = false;
			// Container child vboxNodeView.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vboxNodeView[this.GtkScrolledWindowStavke]));
			w8.Position = 1;
			w8.Expand = false;
			// Container child vboxNodeView.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w10 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.labelUkupno]));
			w10.Position = 1;
			w10.Expand = false;
			w10.Fill = false;
			this.vboxNodeView.Add(this.hbox2);
			global::Gtk.Box.BoxChild w11 = ((global::Gtk.Box.BoxChild)(this.vboxNodeView[this.hbox2]));
			w11.Position = 2;
			w11.Expand = false;
			w11.Fill = false;
			this.hbox1.Add(this.vboxNodeView);
			global::Gtk.Box.BoxChild w12 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.vboxNodeView]));
			w12.Position = 0;
			w12.Expand = false;
			w12.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.comboboxSifraArtikla]));
			w14.Position = 1;
			w14.Expand = false;
			w14.Fill = false;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w15 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.vseparator1]));
			w15.Position = 2;
			w15.Expand = false;
			w15.Fill = false;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.entrySearchForm]));
			w16.Position = 3;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			w17.Pixbuf = global::Stetic.IconLoader.LoadIcon(this, "gtk-find", global::Gtk.IconSize.Button);
			this.buttonSearchForm.Image = w17;
			this.hbox4.Add(this.buttonSearchForm);
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.buttonSearchForm]));
			w18.Position = 4;
			w18.Expand = false;
			w18.Fill = false;
			this.vboxFormView.Add(this.hbox4);
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.vboxFormView[this.hbox4]));
			w19.Position = 0;
			w19.Expand = false;
			w19.Fill = false;
			// Container child vboxFormView.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w20 = ((global::Gtk.Box.BoxChild)(this.hbox5[this.label3]));
			w20.Position = 0;
			w20.Expand = false;
			w20.Fill = false;
			w20.Padding = ((uint)(15));
			...
			global::Gtk.Box.BoxChild w21 = ((global::Gtk.Box.BoxChild)(this.hbox5[this.labelNazivArtikla]));
			w21.Position = 1;
			w21.Expand = false;
			w21.Fill = false;
			...
			global::Gtk.Box.BoxChild w24 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.labelCijenaArtikla]));
			w24.Position = 1;
			w24.Expand = false;
			w24.Fill = false;
			...
			global::Gtk.Box.BoxChild w26 = ((global::Gtk.Box.BoxChild)(this.hbox7[this.label5]));
			w26.Position = 0;
			w26.Expand = false;
			w26.Fill = false;
			w26.Padding = ((uint)(15));
			...
			global::Gtk.Box.BoxChild w27 = ((global::Gtk.Box.BoxChild)(this.hbox7[this.spinbuttonKolicina]));
			w27.Position = 1;
			w27.Expand = false;
			w27.Fill = false;
			...
			global::Gtk.Box.BoxChild w29 = ((global::Gtk.Box.BoxChild)(this.hbox8[this.label6]));
			w29.Position = 0;
			w29.Expand = false;
			w29.Fill = false;
			w29.Padding = ((uint)(15));
			...
			global::Gtk.Box.BoxChild w30 = ((global::Gtk.Box.BoxChild)(this.hbox8[this.labelUkupnoArtikla]));
			w30.Position = 1;
			w30.Expand = false;
			w30.Fill = false;
			this.vboxFormView.Add(this.hbox8);
			global::Gtk.Box.BoxChild w31 = ((global::Gtk.Box.BoxChild)(this.vboxFormView[this.hbox8]));
			w31.Position = 4;
			w31.Expand = false;
			w31.Fill = false;
			// Container child vboxFormView.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w32 = ((global::Gtk.Box.BoxChild)(this.hbox9[this.label7]));
			w32.Position = 0;
			w32.Expand = false;
			w32.Fill = false;
			w32.Padding = ((uint)(15));
			...
			global::Gtk.Box.BoxChild w33 = ((global::Gtk.Box.BoxChild)(this.hbox9[this.comboboxStatus]));
			w33.Position = 1;
			w33.Expand = false;
			w33.Fill = false;
			this.vboxFormView.Add(this.hbox9);
			global::Gtk.Box.BoxChild w34 = ((global::Gtk.Box.BoxChild)(this.vboxFormView[this.hbox9]));
			w34.Position = 5;
			w34.Expand = false;
			w34.Fill = false;
			// Container child vboxFormView.Gtk.Box+BoxChild
			...
			this.buttonOdustani.Image = w35;
			this.hbox10.Add(this.buttonOdustani);
			global::Gtk.Box.BoxChild w36 = ((global::Gtk.Box.BoxChild)(this.hbox10[this.buttonOdustani]));
			w36.Position = 0;
			w36.Expand = false;
			w36.Fill = false;
			// Container child hbox10.Gtk.Box+BoxChild
			...
			w37.Pixbuf = global::Stetic.IconLoader.LoadIcon(this, "gtk-save", global::Gtk.IconSize.Button);
			this.buttonSpremi.Image = w37;
			this.hbox10.Add(this.buttonSpremi);
			global::Gtk.Box.BoxChild w38 = ((global::Gtk.Box.BoxChild)(this.hbox10[this.buttonSpremi]));
			w38.Position = 1;
			w38.Expand = false;
			w38.Fill = false;
			this.vboxFormView.Add(this.hbox10);
			global::Gtk.Box.BoxChild w39 = ((global::Gtk.Box.BoxChild)(this.vboxFormView[this.hbox10]));
			w39.Position = 6;
			w39.Expand = false;
			w39.Fill = false;
			// Container child vboxFormView.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w40 = ((global::Gtk.Box.BoxChild)(this.hboxSpremljeno[this.fixed2]));
			w40.Position = 0;
			w40.Expand = false;
			// Container child hboxSpremljeno.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w41 = ((global::Gtk.Box.BoxChild)(this.hboxSpremljeno[this.image250]));
			w41.Position = 1;
			w41.Expand = false;
			w41.Fill = false;
			// Container child hboxSpremljeno.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w42 = ((global::Gtk.Box.BoxChild)(this.hboxSpremljeno[this.labelSpremljeno]));
			w42.Position = 2;
			w42.Expand = false;
			w42.Fill = false;
			this.vboxFormView.Add(this.hboxSpremljeno);
			global::Gtk.Box.BoxChild w43 = ((global::Gtk.Box.BoxChild)(this.vboxFormView[this.hboxSpremljeno]));
			w43.Position = 7;
			w43.Expand = false;
			w43.Fill = false;
			this.hbox1.Add(this.vboxFormView);
			global::Gtk.Box.BoxChild w44 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.vboxFormView]));
			w44.Position = 1;
			w44.Expand = false;
			w44.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w45 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.fixed1]));
			w45.Position = 0;
			w45.Expand = false;
			w45.Fill = false;
			// Container child vbox2.Gtk.Box+BoxChild
			...
			this.buttonDodajStavku.Image = w46;
			this.vbox2.Add(this.buttonDodajStavku);
			global::Gtk.Box.BoxChild w47 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.buttonDodajStavku]));
			w47.Position = 1;
			w47.Expand = false;
			w47.Fill = false;
			// Container child vbox2.Gtk.Box+BoxChild
			...
			w58.Pixbuf = global::Gdk.Pixbuf.LoadFromResource("NewRestoran.images.lock.png");
			this.buttonZakljuci.Image = w58;
			this.vbox2.Add(this.buttonZakljuci);
			global::Gtk.Box.BoxChild w59 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.buttonZakljuci]));
			w59.Position = 7;
			w59.Expand = false;
			w59.Fill = false;
			this.hbox1.Add(this.vbox2);
			global::Gtk.Box.BoxChild w60 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.vbox2]));
			w60.Position = 2;
			w60.Expand = false;
			w60.Fill = false;
			w60.Padding = ((uint)(30));
